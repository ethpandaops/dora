...
require (
	...
	github.com/attestantio/go-eth2-client v0.19.5-0.20231111085518-de3582f229ec
...
replace github.com/attestantio/go-eth2-client => github.com/gballet/go-eth2-client v0.0.0-20231121154023-5133912653e1
