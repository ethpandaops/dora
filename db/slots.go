	...
	_, err := tx.Exec(EngineQuery(map[dbtypes.DBEngineType]string{
		dbtypes.DBEnginePgsql: `
			INSERT INTO slots (
				...
				eth_block_extra, eth_block_extra_text, sync_participation, fork_id, has_payload
		...
		slot.EthBlockExtra, slot.EthBlockExtraText, slot.SyncParticipation, slot.ForkId, slot.HasPayload)
	if err != nil {
		return err
	}
