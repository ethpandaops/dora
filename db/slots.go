	...
	_, err := tx.Exec(EngineQuery(map[dbtypes.DBEngineType]string{
		dbtypes.DBEnginePgsql: `
			INSERT INTO slots (
				...
				eth_block_extra, eth_block_extra_text, sync_participation, fork_id, blob_count
		...
		slot.EthBlockExtra, slot.EthBlockExtraText, slot.SyncParticipation, slot.ForkId, slot.BlobCount)
	if err != nil {
		return err
	}
