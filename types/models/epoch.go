...
type EpochPageData struct {
	...
	TargetVotedSlashed      uint64    `json:"target_voted_slashed"`
	...
	// Voting participation bar segments, as percent of eligible effective balance.
	// Target bar = TargetVoteParticipation (counts) + TargetVoteSlashedParticipation (ignored) +
	// TargetVoteWrongParticipation (wrong/no target) + MissingParticipation (didn't attest).
	// Head bar = HeadVoteParticipation (counts) + HeadVoteWrongParticipation + MissingParticipation.
	TargetVoteSlashedParticipation float64              `json:"target_vote_slashed_participation"`
	TargetVoteWrongParticipation   float64              `json:"target_vote_wrong_participation"`
	HeadVoteWrongParticipation     float64              `json:"head_vote_wrong_participation"`
	MissingParticipation           float64              `json:"missing_participation"`
