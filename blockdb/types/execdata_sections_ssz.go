...
func (t *ReceiptMetaData) UnmarshalSSZ(buf []byte) (err error) {
	buflen := len(buf)
	if buflen < 377 {
		return sszutils.NewSszErrorf(sszutils.ErrUnexpectedEOF, "not enough data for fixed fields (have %d, needed %d)", buflen, 377)
	}
...
func (t *BlockReceiptMeta) UnmarshalSSZ(buf []byte) (err error) {
	buflen := len(buf)
	if buflen < 10 {
		return sszutils.NewSszErrorf(sszutils.ErrUnexpectedEOF, "not enough data for fixed fields (have %d, needed %d)", buflen, 10)
	}
	{ // Field #0 'Version' (static)
		buf := buf[0:2]
		t.Version = binary.LittleEndian.Uint16(buf)
...
func (t *StateChangeAccount) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	{ // Dynamic Field #6 'PreCode'
		binary.LittleEndian.PutUint32(dst[dstlen+101:], uint32(len(dst)-dstlen))
		dst = append(dst, t.PreCode[:]...)
	}
	{ // Dynamic Field #7 'PostCode'
		binary.LittleEndian.PutUint32(dst[dstlen+105:], uint32(len(dst)-dstlen))
		dst = append(dst, t.PostCode[:]...)
	}
	{ // Dynamic Field #8 'Slots'
		binary.LittleEndian.PutUint32(dst[dstlen+109:], uint32(len(dst)-dstlen))
		t := t.Slots
		vlen := len(t)
		for idx1 := range vlen {
			t := &t[idx1]
...
func (t *StateChangeAccount) UnmarshalSSZ(buf []byte) (err error) {
	buflen := len(buf)
	if buflen < 113 {
		return sszutils.NewSszErrorf(sszutils.ErrUnexpectedEOF, "not enough data for fixed fields (have %d, needed %d)", buflen, 113)
	}
	...
	if offset6 != 113 {
		return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrOffset, "first offset does not match (offset: %d, static len: %d)", offset6, 113), "PreCode:o")
	}
	// Field #7 'PostCode' (offset)
	offset7 := int(binary.LittleEndian.Uint32(buf[105:109]))
	if offset7 < offset6 || offset7 > buflen {
		return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrOffset, "offset out of range (offset=%d, prev=%d, buflen=%d)", offset7, offset6, buflen), "PostCode:o")
	}
	// Field #8 'Slots' (offset)
	offset8 := int(binary.LittleEndian.Uint32(buf[109:113]))
	if offset8 < offset7 || offset8 > buflen {
		return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrOffset, "offset out of range (offset=%d, prev=%d, buflen=%d)", offset8, offset7, buflen), "Slots:o")
	}
	...
	{ // Field #8 'Slots' (dynamic)
		...
		if len(buf)%96 != 0 {
			return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrUnexpectedEOF, "list length %d not a multiple of element size %d", len(buf), 96), "Slots")
		}
		...
		for idx1 := range itemCount {
			...
			buflen := len(buf)
			if buflen < 96 {
				return sszutils.ErrorWithPathf(sszutils.NewSszErrorf(sszutils.ErrUnexpectedEOF, "not enough data for fixed fields (have %d, needed %d)", buflen, 96), "Slots[%d]", idx1)
			}
			{ // Field #0 'Slot' (static)
				buf := buf[0:32]
				copy(val4.Slot[:], buf)
...
func (t *FlatCallFrame) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	{ // Dynamic Field #8 'Input'
		binary.LittleEndian.PutUint32(dst[dstlen+92:], uint32(len(dst)-dstlen))
...
func (t *FlatCallFrame) UnmarshalSSZ(buf []byte) (err error) {
	buflen := len(buf)
	if buflen < 104 {
		return sszutils.NewSszErrorf(sszutils.ErrUnexpectedEOF, "not enough data for fixed fields (have %d, needed %d)", buflen, 104)
	}
	...
	if offset8 != 104 {
		return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrOffset, "first offset does not match (offset: %d, static len: %d)", offset8, 104), "Input:o")
	}
	// Field #9 'Output' (offset)
	offset9 := int(binary.LittleEndian.Uint32(buf[96:100]))
	if offset9 < offset8 || offset9 > buflen {
		return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrOffset, "offset out of range (offset=%d, prev=%d, buflen=%d)", offset9, offset8, buflen), "Output:o")
	}
	// Field #10 'Error' (offset)
	offset10 := int(binary.LittleEndian.Uint32(buf[100:104]))
	if offset10 < offset9 || offset10 > buflen {
		return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrOffset, "offset out of range (offset=%d, prev=%d, buflen=%d)", offset10, offset9, buflen), "Error:o")
	}
...
func (t *EventData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	{ // Dynamic Field #2 'Topics'
		...
		vlen := len(t)
		if vlen > 5 {
			return nil, sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrListTooBig, "list length %d exceeds maximum %d", vlen, 5), "Topics")
		}
		for idx1 := range vlen {
			vlen := len(t[idx1])
			if vlen > 32 {
				return nil, sszutils.ErrorWithPathf(sszutils.NewSszErrorf(sszutils.ErrVectorLength, "vector length %d exceeds limit %d", vlen, 32), "Topics[%d]", idx1)
			}
...
func (t *EventData) UnmarshalSSZ(buf []byte) (err error) {
	buflen := len(buf)
	if buflen < 32 {
		return sszutils.NewSszErrorf(sszutils.ErrUnexpectedEOF, "not enough data for fixed fields (have %d, needed %d)", buflen, 32)
	}
	...
	if offset2 != 32 {
		return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrOffset, "first offset does not match (offset: %d, static len: %d)", offset2, 32), "Topics:o")
	}
	// Field #3 'Data' (offset)
	offset3 := int(binary.LittleEndian.Uint32(buf[28:32]))
	if offset3 < offset2 || offset3 > buflen {
		return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrOffset, "offset out of range (offset=%d, prev=%d, buflen=%d)", offset3, offset2, buflen), "Data:o")
	}
	{ // Field #2 'Topics' (dynamic)
		...
		if len(buf)%32 != 0 {
			return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrUnexpectedEOF, "list length %d not a multiple of element size %d", len(buf), 32), "Topics")
		}
...
func (t *EventData) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	{ // Field #2 'Topics'
		...
		vlen := uint64(len(t))
		if vlen > 5 {
			return sszutils.ErrorWithPath(sszutils.NewSszErrorf(sszutils.ErrListTooBig, "list length %d exceeds maximum %d", vlen, 5), "Topics")
		}
		idx := hh.Index()
		for idx1 := range int(vlen) {
			vlen := len(t[idx1])
			if vlen > 32 {
				return sszutils.ErrorWithPathf(sszutils.NewSszErrorf(sszutils.ErrVectorLength, "vector length %d exceeds limit %d", vlen, 32), "Topics[%d]", idx1)
			}
			val := t[idx1][:]
			if vlen < 32 {
