...
// Hash: 5315d4cfc4bc8e5dcb3f61ee691cbeb6ed8e121cbf8df66d3a2f0db2a9e0bc0b
...
func (t *ReceiptMetaData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	{ // Static Field #1 'Status'
		dst = append(dst, byte(t.Status))
	}
	{ // Static Field #2 'TxType'
		dst = append(dst, byte(t.TxType))
	}
	{ // Static Field #3 'CumulativeGasUsed'
		dst = binary.LittleEndian.AppendUint64(dst, t.CumulativeGasUsed)
	}
	{ // Static Field #4 'GasUsed'
		dst = binary.LittleEndian.AppendUint64(dst, t.GasUsed)
	}
	{ // Static Field #5 'EffectiveGasPrice'
		t := &t.EffectiveGasPrice
		if data, err := t.MarshalSSZ(); err != nil {
			return nil, sszutils.ErrorWithPath(err, "EffectiveGasPrice")
		} else {
			dst = append(dst, data...)
		}
	}
	{ // Static Field #6 'BlobGasUsed'
		dst = binary.LittleEndian.AppendUint64(dst, t.BlobGasUsed)
	}
	{ // Static Field #7 'LogsBloom'
	...
	{ // Static Field #10 'ContractAddress'
		dst = append(dst, t.ContractAddress[:20]...)
	}
	{ // Static Field #11 'HasContractAddr'
...
func (t *ReceiptMetaData) UnmarshalSSZ(buf []byte) (err error) {
	...
	{ // Field #5 'EffectiveGasPrice' (static)
		buf := buf[20:52]
		if err = t.EffectiveGasPrice.UnmarshalSSZ(buf); err != nil {
			return sszutils.ErrorWithPath(err, "EffectiveGasPrice")
		}
	}
...
func (t *ReceiptMetaData) SizeSSZ() int {
	return 377
}
...
func (t *BlockReceiptMeta) SizeSSZ() int {
	return 10
}
...
func (t *StateChangeAccount) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dstlen := len(dst)
	{ // Static Field #0 'Address'
		dst = append(dst, t.Address[:20]...)
	}
	{ // Static Field #1 'Flags'
		dst = append(dst, byte(t.Flags))
	}
	{ // Static Field #2 'PreBalance'
		t := &t.PreBalance
		if data, err := t.MarshalSSZ(); err != nil {
			return nil, sszutils.ErrorWithPath(err, "PreBalance")
		} else {
			dst = append(dst, data...)
		}
	}
	{ // Static Field #3 'PostBalance'
		t := &t.PostBalance
		if data, err := t.MarshalSSZ(); err != nil {
			return nil, sszutils.ErrorWithPath(err, "PostBalance")
		} else {
			dst = append(dst, data...)
		}
	}
	{ // Static Field #4 'PreNonce'
		dst = binary.LittleEndian.AppendUint64(dst, t.PreNonce)
	}
	{ // Static Field #5 'PostNonce'
		dst = binary.LittleEndian.AppendUint64(dst, t.PostNonce)
	}
	// Offset Field #6 'PreCode'
	// Offset Field #7 'PostCode'
	// Offset Field #8 'Slots'
	...
	{ // Dynamic Field #6 'PreCode'
		if off := uint64(len(dst)) - uint64(dstlen); off > math.MaxUint32 {
			...
			binary.LittleEndian.PutUint32(dst[dstlen+101:], uint32(off))
		}
		vlen := len(t.PreCode)
		if vlen > 10485760 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "PreCode")
		}
	...
	{ // Dynamic Field #7 'PostCode'
		if off := uint64(len(dst)) - uint64(dstlen); off > math.MaxUint32 {
			...
			binary.LittleEndian.PutUint32(dst[dstlen+105:], uint32(off))
		}
		vlen := len(t.PostCode)
		if vlen > 10485760 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "PostCode")
		}
	...
	{ // Dynamic Field #8 'Slots'
		if off := uint64(len(dst)) - uint64(dstlen); off > math.MaxUint32 {
			...
			binary.LittleEndian.PutUint32(dst[dstlen+109:], uint32(off))
		}
		t := t.Slots
		vlen := len(t)
		if vlen > 10485760 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Slots")
		}
		for idx1 := range vlen {
			t := &t[idx1]
			{ // Static Field #0 'Slot'
			...
			{ // Static Field #1 'PreValue'
				dst = append(dst, t.PreValue[:32]...)
			}
			{ // Static Field #2 'PostValue'
...
func (t *StateChangeAccount) UnmarshalSSZ(buf []byte) (err error) {
	buflen := uint64(len(buf))
	if buflen < 113 {
		return sszutils.ErrFixedFieldsEOFFn(buflen, 113)
	}
	...
	{ // Field #2 'PreBalance' (static)
		buf := buf[21:53]
		if err = t.PreBalance.UnmarshalSSZ(buf); err != nil {
			return sszutils.ErrorWithPath(err, "PreBalance")
		}
	}
	{ // Field #3 'PostBalance' (static)
		buf := buf[53:85]
		if err = t.PostBalance.UnmarshalSSZ(buf); err != nil {
			return sszutils.ErrorWithPath(err, "PostBalance")
		}
	}
	...
	offset6 := binary.LittleEndian.Uint32(buf[101:105])
	if offset6 != 113 {
		return sszutils.ErrorWithPath(sszutils.ErrFirstOffsetMismatchFn(offset6, 113), "PreCode:o")
	}
	// Field #7 'PostCode' (offset)
	offset7 := binary.LittleEndian.Uint32(buf[105:109])
	if offset7 < offset6 || offset7 > maxOffset {
		return sszutils.ErrorWithPath(sszutils.ErrOffsetOutOfRangeFn(offset7, offset6, buflen), "PostCode:o")
	}
	// Field #8 'Slots' (offset)
	offset8 := binary.LittleEndian.Uint32(buf[109:113])
	if offset8 < offset7 || offset8 > maxOffset {
		return sszutils.ErrorWithPath(sszutils.ErrOffsetOutOfRangeFn(offset8, offset7, buflen), "Slots:o")
	}
	{ // Field #6 'PreCode' (dynamic)
		buf := buf[offset6:offset7]
		if len(buf) > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(len(buf), 10485760), "PreCode")
		}
	...
	{ // Field #7 'PostCode' (dynamic)
		...
		if len(buf) > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(len(buf), 10485760), "PostCode")
		}
	...
	{ // Field #8 'Slots' (dynamic)
		...
		if len(buf)%96 != 0 {
			return sszutils.ErrorWithPath(sszutils.ErrListNotAlignedFn(len(buf), 96), "Slots")
		}
		if itemCount > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(itemCount, 10485760), "Slots")
		}
		...
		for idx1 := range itemCount {
			...
			{ // Field #1 'PreValue' (static)
				buf := buf[32:64]
				copy(val2.PreValue[:], buf)
			}
			{ // Field #2 'PostValue' (static)
				buf := buf[64:96]
				copy(val2.PostValue[:], buf)
			}
			val1[idx1] = val2
		}
		t.Slots = val1
...
func (t *StateChangeAccount) SizeSSZ() int {
	var size int64
	if t == nil {
		t = new(StateChangeAccount)
	}
	...
	size += 113
	{ // Dynamic field #6 'PreCode'
		size += int64(len(t.PreCode))
	}
	{ // Dynamic field #7 'PostCode'
		size += int64(len(t.PostCode))
	}
	{ // Dynamic field #8 'Slots'
		size += int64(len(t.Slots)) * 96
	}
...
func (t *StateChangeAccount) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	{ // Field #6 'PreCode'
		vlen := uint64(len(t.PreCode))
		if vlen > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "PreCode")
		}
		idx := hh.StartTree(sszutils.TreeTypeBinary | sszutils.TreeTypePacked)
		hh.AppendBytes32(t.PreCode[:])
		hh.MerkleizeWithMixin(idx, vlen, sszutils.CalculateLimit(10485760, vlen, 1))
	}
	{ // Field #7 'PostCode'
		vlen := uint64(len(t.PostCode))
		if vlen > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "PostCode")
		}
		idx := hh.StartTree(sszutils.TreeTypeBinary | sszutils.TreeTypePacked)
	...
	{ // Field #8 'Slots'
		...
		vlen := uint64(len(t))
		if vlen > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Slots")
		}
		...
		hh.MerkleizeWithMixin(idx, vlen, sszutils.CalculateLimit(10485760, vlen, 32))
	}
	hh.Merkleize(idx)
	return nil
}
...
func (t *FlatCallFrame) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	{ // Static Field #4 'Value'
		t := &t.Value
		if data, err := t.MarshalSSZ(); err != nil {
			return nil, sszutils.ErrorWithPath(err, "Value")
		} else {
			dst = append(dst, data...)
		}
	}
	...
	{ // Static Field #6 'GasUsed'
		dst = binary.LittleEndian.AppendUint64(dst, t.GasUsed)
	}
	{ // Static Field #7 'Status'
		dst = append(dst, byte(t.Status))
	}
	// Offset Field #8 'Input'
	// Offset Field #9 'Output'
	// Offset Field #10 'Error'
	dst = append(dst, zeroBytes[:12]...)
	{ // Dynamic Field #8 'Input'
		if off := uint64(len(dst)) - uint64(dstlen); off > math.MaxUint32 {
			return nil, sszutils.ErrOffsetOverflowFn(off)
		} else {
			binary.LittleEndian.PutUint32(dst[dstlen+92:], uint32(off))
		}
		vlen := len(t.Input)
		if vlen > 10485760 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Input")
		}
	...
	{ // Dynamic Field #9 'Output'
		if off := uint64(len(dst)) - uint64(dstlen); off > math.MaxUint32 {
			...
			binary.LittleEndian.PutUint32(dst[dstlen+96:], uint32(off))
		}
		vlen := len(t.Output)
		if vlen > 10485760 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Output")
		}
	...
	{ // Dynamic Field #10 'Error'
		if off := uint64(len(dst)) - uint64(dstlen); off > math.MaxUint32 {
			...
			binary.LittleEndian.PutUint32(dst[dstlen+100:], uint32(off))
		}
		vlen := len(t.Error)
		if vlen > 10485760 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Error")
		}
...
func (t *FlatCallFrame) UnmarshalSSZ(buf []byte) (err error) {
	buflen := uint64(len(buf))
	if buflen < 104 {
		return sszutils.ErrFixedFieldsEOFFn(buflen, 104)
	}
	maxOffset := uint32(sszutils.Min(buflen, math.MaxUint32))
	...
	{ // Field #4 'Value' (static)
		buf := buf[43:75]
		if err = t.Value.UnmarshalSSZ(buf); err != nil {
	...
	offset8 := binary.LittleEndian.Uint32(buf[92:96])
	if offset8 != 104 {
		return sszutils.ErrorWithPath(sszutils.ErrFirstOffsetMismatchFn(offset8, 104), "Input:o")
	}
	// Field #9 'Output' (offset)
	offset9 := binary.LittleEndian.Uint32(buf[96:100])
	if offset9 < offset8 || offset9 > maxOffset {
		return sszutils.ErrorWithPath(sszutils.ErrOffsetOutOfRangeFn(offset9, offset8, buflen), "Output:o")
	}
	// Field #10 'Error' (offset)
	offset10 := binary.LittleEndian.Uint32(buf[100:104])
	if offset10 < offset9 || offset10 > maxOffset {
		return sszutils.ErrorWithPath(sszutils.ErrOffsetOutOfRangeFn(offset10, offset9, buflen), "Error:o")
	}
	{ // Field #8 'Input' (dynamic)
		buf := buf[offset8:offset9]
		if len(buf) > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(len(buf), 10485760), "Input")
		}
	...
	{ // Field #9 'Output' (dynamic)
		...
		if len(buf) > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(len(buf), 10485760), "Output")
		}
	...
	{ // Field #10 'Error' (dynamic)
		buf := buf[offset10:]
		if len(buf) > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(len(buf), 10485760), "Error")
		}
		t.Error = string(buf)
	}
	return nil
...
func (t *FlatCallFrame) SizeSSZ() int {
	var size int64
	if t == nil {
		t = new(FlatCallFrame)
	}
	...
	size += 104
	{ // Dynamic field #8 'Input'
		size += int64(len(t.Input))
	}
	{ // Dynamic field #9 'Output'
		size += int64(len(t.Output))
	}
	{ // Dynamic field #10 'Error'
		size += int64(len(t.Error))
	}
	if uint64(size) > sszutils.MaxSszSize {
		return -1
	}
...
func (t *FlatCallFrame) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	{ // Field #8 'Input'
		vlen := uint64(len(t.Input))
		if vlen > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Input")
		}
		idx := hh.StartTree(sszutils.TreeTypeBinary | sszutils.TreeTypePacked)
	...
	{ // Field #9 'Output'
		vlen := uint64(len(t.Output))
		if vlen > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Output")
		}
		idx := hh.StartTree(sszutils.TreeTypeBinary | sszutils.TreeTypePacked)
	...
	{ // Field #10 'Error'
		vlen := uint64(len(t.Error))
		if vlen > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Error")
		}
		idx := hh.StartTree(sszutils.TreeTypeBinary | sszutils.TreeTypePacked)
...
func (t *EventData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	{ // Dynamic Field #2 'Topics'
		...
		vlen := len(t)
		if vlen > 5 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 5), "Topics")
		}
		for idx1 := range vlen {
			vlen := len(t[idx1])
			if vlen > 32 {
				return nil, sszutils.ErrorWithPathf(sszutils.ErrVectorLengthFn(vlen, 32), "Topics[%d]", idx1)
			}
	...
	{ // Dynamic Field #3 'Data'
		if off := uint64(len(dst)) - uint64(dstlen); off > math.MaxUint32 {
			...
			binary.LittleEndian.PutUint32(dst[dstlen+28:], uint32(off))
		}
		vlen := len(t.Data)
		if vlen > 10485760 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Data")
		}
...
func (t *EventData) UnmarshalSSZ(buf []byte) (err error) {
	...
	offset2 := binary.LittleEndian.Uint32(buf[24:28])
	if offset2 != 32 {
		return sszutils.ErrorWithPath(sszutils.ErrFirstOffsetMismatchFn(offset2, 32), "Topics:o")
	}
	// Field #3 'Data' (offset)
	offset3 := binary.LittleEndian.Uint32(buf[28:32])
	if offset3 < offset2 || offset3 > maxOffset {
		return sszutils.ErrorWithPath(sszutils.ErrOffsetOutOfRangeFn(offset3, offset2, buflen), "Data:o")
	}
	{ // Field #2 'Topics' (dynamic)
		...
		if len(buf)%32 != 0 {
			return sszutils.ErrorWithPath(sszutils.ErrListNotAlignedFn(len(buf), 32), "Topics")
		}
		if itemCount > 5 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(itemCount, 5), "Topics")
		}
		val1 = sszutils.ExpandSlice(val1, itemCount)
		for idx1 := range itemCount {
	...
	{ // Field #3 'Data' (dynamic)
		buf := buf[offset3:]
		if len(buf) > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(len(buf), 10485760), "Data")
		}
...
func (t *EventData) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	{ // Field #2 'Topics'
		...
		vlen := uint64(len(t))
		if vlen > 5 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 5), "Topics")
		}
		idx := hh.StartTree(sszutils.TreeTypeBinary)
		for idx1 := range len(t) {
			vlen := len(t[idx1])
	...
	{ // Field #3 'Data'
		...
		if vlen > 10485760 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 10485760), "Data")
		}
		idx := hh.StartTree(sszutils.TreeTypeBinary | sszutils.TreeTypePacked)
...
// MarshalSSZ marshals the *FrameReceiptData to SSZ-encoded bytes.
func (t *FrameReceiptData) MarshalSSZ() ([]byte, error) {
	return dynssz.GetGlobalDynSsz().MarshalSSZ(t)
}

// MarshalSSZTo marshals the *FrameReceiptData to SSZ-encoded bytes, appending to the provided buffer.
func (t *FrameReceiptData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	if t == nil {
		t = new(FrameReceiptData)
	}
	dstlen := len(dst)
	{ // Static Field #0 'Payer'
		dst = append(dst, t.Payer[:20]...)
	}
	// Offset Field #1 'Frames'
	dst = append(dst, 0, 0, 0, 0)
	{ // Dynamic Field #1 'Frames'
		if off := uint64(len(dst)) - uint64(dstlen); off > math.MaxUint32 {
			return nil, sszutils.ErrOffsetOverflowFn(off)
		} else {
		...
		vlen := len(t)
		if vlen > 64 {
			return nil, sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 64), "Frames")
		}
		for idx1 := range vlen {
			t := &t[idx1]
			...
			{ // Static Field #1 'ExecGasUsed'
				dst = binary.LittleEndian.AppendUint64(dst, t.ExecGasUsed)
			}
			{ // Static Field #2 'StateGasUsed'
				dst = binary.LittleEndian.AppendUint64(dst, t.StateGasUsed)
			}
			{ // Static Field #3 'LogCount'
				dst = binary.LittleEndian.AppendUint32(dst, t.LogCount)
			}
		}
	}
	return dst, nil
...
// UnmarshalSSZ unmarshals the *FrameReceiptData from SSZ-encoded bytes.
func (t *FrameReceiptData) UnmarshalSSZ(buf []byte) (err error) {
	buflen := uint64(len(buf))
	if buflen < 24 {
		return sszutils.ErrFixedFieldsEOFFn(buflen, 24)
	}
	{ // Field #0 'Payer' (static)
		buf := buf[0:20]
		copy(t.Payer[:], buf)
	}
	// Field #1 'Frames' (offset)
	offset1 := binary.LittleEndian.Uint32(buf[20:24])
	if offset1 != 24 {
		return sszutils.ErrorWithPath(sszutils.ErrFirstOffsetMismatchFn(offset1, 24), "Frames:o")
	}
	{ // Field #1 'Frames' (dynamic)
		buf := buf[offset1:]
		val1 := t.Frames
		itemCount := len(buf) / 21
		if len(buf)%21 != 0 {
			return sszutils.ErrorWithPath(sszutils.ErrListNotAlignedFn(len(buf), 21), "Frames")
		}
		if itemCount > 64 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(itemCount, 64), "Frames")
		}
		val1 = sszutils.ExpandSlice(val1, itemCount)
		for idx1 := range itemCount {
			val2 := val1[idx1]
			buf := buf[21*idx1 : 21*(idx1+1)]
			buflen := uint64(len(buf))
			if 21 != buflen {
				if 21 > buflen {
					return sszutils.ErrorWithPathf(sszutils.ErrFixedFieldsEOFFn(buflen, 21), "Frames[%d]", idx1)
				}
				return sszutils.ErrorWithPathf(sszutils.ErrTrailingDataFn(buflen-21), "Frames[%d]", idx1)
			}
			{ // Field #0 'Status' (static)
				buf := buf[0:1]
				val2.Status = buf[0]
			}
			{ // Field #1 'ExecGasUsed' (static)
				buf := buf[1:9]
				val2.ExecGasUsed = binary.LittleEndian.Uint64(buf)
			}
			{ // Field #2 'StateGasUsed' (static)
				buf := buf[9:17]
				val2.StateGasUsed = binary.LittleEndian.Uint64(buf)
			}
			{ // Field #3 'LogCount' (static)
				buf := buf[17:21]
				val2.LogCount = binary.LittleEndian.Uint32(buf)
			}
			val1[idx1] = val2
		}
		t.Frames = val1
...
// SizeSSZ returns the SSZ encoded size of the *FrameReceiptData.
func (t *FrameReceiptData) SizeSSZ() int {
	var size int64
	if t == nil {
		t = new(FrameReceiptData)
	}
	// Field #0 'Payer' static (20 bytes)
	// Field #1 'Frames' offset (4 bytes)
	size += 24
	{ // Dynamic field #1 'Frames'
		size += int64(len(t.Frames)) * 21
	}
	if uint64(size) > sszutils.MaxSszSize {
		return -1
	}
...
// HashTreeRoot computes the SSZ hash tree root of the *FrameReceiptData.
func (t *FrameReceiptData) HashTreeRoot() (root [32]byte, err error) {
	err = hasher.WithDefaultHasher(func(hh sszutils.HashWalker) (err error) {
		err = t.HashTreeRootWith(hh)
		if err == nil {
			root, err = hh.HashRoot()
...
// HashTreeRootWith computes the SSZ hash tree root of the *FrameReceiptData using the given hash walker.
func (t *FrameReceiptData) HashTreeRootWith(hh sszutils.HashWalker) error {
	if t == nil {
		t = new(FrameReceiptData)
	}
	idx := hh.StartTree(sszutils.TreeTypeNone)
	{ // Field #0 'Payer'
		hh.PutBytes(t.Payer[:20])
	}
	{ // Field #1 'Frames'
		t := t.Frames
		vlen := uint64(len(t))
		if vlen > 64 {
			return sszutils.ErrorWithPath(sszutils.ErrListLengthFn(vlen, 64), "Frames")
		}
		idx := hh.StartTree(sszutils.TreeTypeBinary)
		for idx1 := range len(t) {
			t := &t[idx1]
			...
			{ // Field #1 'ExecGasUsed'
				hh.PutUint64(t.ExecGasUsed)
			}
			{ // Field #2 'StateGasUsed'
				hh.PutUint64(t.StateGasUsed)
			}
			{ // Field #3 'LogCount'
				hh.PutUint32(t.LogCount)
			}
			hh.Merkleize(idx)
			if (idx1+1)%256 == 0 {
				hh.Collapse()
