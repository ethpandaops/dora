...
func buildSlotPageData(ctx context.Context, blockSlot int64, blockRoot []byte) (*models.SlotPageData, time.Duration) {
	...
	if blockData == nil {
		...
		pageData.ProposerName = services.GlobalBeaconService.GetProposerName(nil, pageData.Proposer, slot)
	} else {
		...
		pageData.ProposerName = services.GlobalBeaconService.GetProposerName(nil, pageData.Proposer, blockData.Header.Message.Slot)
