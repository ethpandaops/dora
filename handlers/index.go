...
func IndexData(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("X-Server-Time", strconv.FormatInt(services.GlobalBeaconService.GetChainState().Now().UnixMilli(), 10))
